    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">ICT-JAVA 관리자 페이지</a>
...
<!-- 		</div> -->
	...
	List<Board_info> list = conn.get_board(); %>
        <!-- Header-->
        <table class="table table-borderd" margin : auto;>
       	<thead>
       	<tr>
       		<th>번호</th>
       		<th>제목</th>
...
%>
	<tr>
		<td colspan="6" align="right">
			<button onclick="location.href='insert.jsp'" class="btn_b">글쓰기</button>
		</td>
	</tr>
       ...
       <hr/>
<!--        민호형 작업하세여 -->
       <button onclick="location.href='insert_product.jsp'" class="btn_b btn-warning" style="float: right; ">상품 등록</button>       
